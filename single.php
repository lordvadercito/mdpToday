				...
				<div id="container">
				 ...
				 <ul class="navbar-nav mr-auto">
				     	<li class="nav-item active">
				      	...
				      	<li class="nav-item">
				        	<a class="nav-link closeMenu" href="http://c1240192.ferozo.com/mdptoday/category/noticias/"><img src="<?php bloginfo('template_url'); ?>/img/icons/noticias-b.png" class="icon-btn">Noticias</a>
				      	</li>
				      	<li class="nav-item">

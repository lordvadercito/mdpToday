...
<body>
	<header id="header" class="header-fixed-top">
		<nav class="navbar navbar-expand-lg navbar-light bg-color-white">
  			<a class="navbar-brand" href="index.php"><img class="img-logo" src="<?php bloginfo('template_url'); ?>/img/logos/logoslogan-08.png" alt="MDP Today"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
  	<div id="hidden-lg-bar" class="row container-bar">
  		<div class="medium-bar">
  			<img src="<?php bloginfo('template_url'); ?>/img/weather/cloudy-w.png" alt="Nublado" class="weather-img-mobile"><span id="current-temp-mobile" class="temp-actual-mobile"></span><span class="max-min" id="max-Temp">23&#176;</span>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link closeMenu" href="#outstanding-news"><img src="<?php bloginfo('template_url'); ?>/img/icons/home-b.png" class="icon-btn">Home</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link closeMenu" href="#sports"><img src="<?php bloginfo('template_url'); ?>/img/icons/deportes-b.png" class="icon-btn">Deportes</a>
      </li>
        <li class="nav-item">
        <a class="nav-link closeMenu" href="#tecnology"><img src="<?php bloginfo('template_url'); ?>/img/icons/tecnologia-b.png" class="icon-btn">Tecnología</a>
      </li>
        <li class="nav-item">
        <a class="nav-link closeMenu" href="#entertainment"><img src="<?php bloginfo('template_url'); ?>/img/icons/entretenimiento-b.png" class="icon-btn">Entretenimiento</a>
      </li>
    </ul>
  </div>
</nav>
		...
		<div class="row sponsor-banner d-none d-md-block" style="margin: 90px 0 10px 0;">
			<img class="img-responsive" src="<?php bloginfo('template_url'); ?>/img/banners/publicidad-desktop.png" alt="Publicidad">
		</div>
...
<!--Sociedad, Noticias en general-->
    <section class="container" id="news">
        ...
        <div class="row initial">
            ...
            <a role="button" href="http://c1240192.ferozo.com/mdptoday/category/noticias/" class="col-lg-1 col-md-3 col-sm-2 btn-seemore">Ver más</a>
        </div>
 ...
 <!-- Deportes -->
	<section class="container" id="sports">
		<div class="row span-content d-none d-md-block">
			...
			<a role="button" href="http://c1240192.ferozo.com/mdptoday/category/deportes/" class="col-lg-1 col-md-3 col-sm-2 btn-seemore">Ver más</a>	
		</div>
		<div class="social-top-content col-lg-2 d-md-none d-xs-none d-sm-none">
			<a href="#" title="Dale Me Gusta a nuestra Fan Page de Facebook"><p class="social-icon top-social">F</p></a>
			<a href="#" title="Seguinos en Twitter"><p class="social-icon top-social">T</p></a>
...
<!-- Tecnologia -->
 <section class="container" id="tecnology">
		<div class="row initial">
			<div class="section-title-content min-top col-lg-10 col-md-8 col-sm-12">
				<img src="<?php bloginfo('template_url'); ?>/img/icons/tecnologia-w.png" alt="Tecnologia" class="section-icon">
				<h2 class="section-title">Tecnología</h2>
			</div>
			<a role="button" href="http://c1240192.ferozo.com/mdptoday/category/tecnologia/" class="col-lg-1 col-md-3 col-sm-2 btn-seemore">Ver más</a>	
		</div>
		<div class="row news-content">
		...
		<section class="container" id="entertainment">
			<div class="row initial">
				<div class="section-title-content min-top col-lg-10 col-md-8 col-sm-12">
					<img src="<?php bloginfo('template_url'); ?>/img/icons/entretenimiento-w.png" alt="Entretenimiento" class="section-icon">
					<h2 class="section-title">Entretenimiento</h2>
				</div>
				<a role="button" href="http://c1240192.ferozo.com/mdptoday/category/entretenimiento/" class="col-lg-1 col-md-3 col-sm-2 btn-seemore">Ver más</a>	
			</div>
			<div class="row news-content">
				<article class="col-lg-8 col-md-8 col-sm-12 article-content">
					<h4 class="span-content-inner d-none d-block d-sm-none" id="dateFieldSmall"></h4>

...
function weatherIconSelec(icon){
    switch(icon) {
    case 1:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/sun-w.png", "alt":"Soleado"});
        break;
    case 2:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
        break;
    case 3:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
    case 4:
    ...
    case 5:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
    case 6:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Nublado"});
    case 7:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Nublado"});
    case 8:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Nublado"});
    case 11:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-w.png", "alt":"Nublado"});
    case 12:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/rain-w.png", "alt":"Lluvia"});
    case 13:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/rain-w.png", "alt":"Lluvia"});
    case 14:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/rain-w.png", "alt":"Lluvia"});
    case 15:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 16:
         $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 17:
         $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 18:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/rain-w.png", "alt":"Lluvia"});
    case 33:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/moon-w.png", "alt":"Noche despejada"});
    case 34:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/moon-w.png", "alt":"Noche despejada"});
    case 35:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    case 36:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    case 37:
        $('#weather-icon').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/weather/cloud-night-w.png", "alt":"Noche nublada"});
...
$(document).ready(function(){
    ...
    if (sizeDetection()<1191) {
        $('.img-logo').attr({"src":"http://mdptoday.com.ar/wp-content/themes/mdptoday/img/logos/logo-35.png", "margin":"0 10%"});
    }
...
$(document).on("scroll", function() {
	...
	if($(document).scrollTop()>100) {
		...
		$('.img-logo').attr("src","http://mdptoday.com.ar/wp-content/themes/mdptoday/img/logos/logo-35.png");
        ...
        if (sizeDetection() < 992) {
    		...
    		$('.img-logo').attr("src","http://mdptoday.com.ar/wp-content/themes/mdptoday/img/logos/logoslogan-08.png");
